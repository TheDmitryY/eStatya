...
async def get_current_user_claims(
    ...
    try:
        payload = jwt.decode(effective_token, auth_settings.SECRET_KEY, algorithms=[auth_settings.ALGORITHM])
...
def role_required(role: str):
    async def role_checker(current_user: Annotated[dict, Depends(get_current_user_claims)]):
